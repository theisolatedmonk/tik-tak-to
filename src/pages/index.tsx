      ...
      <>
        {winPlayer && (
          <div className="h-screen w-full bg-black/90 fixed flex items-center justify-center text-white  ">
            <button className="font-bold border px-4 border-black absolute top-20 right-20" onClick={() => setWinPlayer(null)}>Close</button>
            <p className="text-5xl  font-bold">Player {winPlayer} Win </p>
          </div>
        )}
      </>
    </main>
